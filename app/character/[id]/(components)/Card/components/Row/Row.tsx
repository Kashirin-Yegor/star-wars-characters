...
const RowName = observer(() => {
    ...
    return <div>
        ...
        {isEditing ? (
            <Input id="name" value={displayCharacter?.name} onChange={(e) => store.handleInputChange("name", e.target.value)} className="mt-1" />
        ) : (
...
const RowHeight = observer(() => {
    ...
    return <div>
        <Label>Рост</Label>
        {isEditing ? (
            <Input id="height" value={displayCharacter?.height} onChange={(e) => store.handleInputChange("height", e.target.value)} className="mt-1" />
        ) : (
...
const RowWeight = observer(() => {
    ...
    return <div>
        <Label>Вес</Label>
        {isEditing ? (
            <Input id="mass" value={displayCharacter?.mass} onChange={(e) => store.handleInputChange("mass", e.target.value)} className="mt-1" />
        ) : (
...
const RowHairColor = observer(() => {
    ...
    return  <div>
        ...
        {isEditing ? (
            <Input id="hair_color" value={displayCharacter?.hair_color} onChange={(e) => store.handleInputChange("hair_color", e.target.value)} className="mt-1" />
        ) : (
...
const RowSkinColor = observer(() => {
    ...
    return <div>
        ...
        {isEditing ? (
            <Input id="skin_color" value={displayCharacter?.skin_color} onChange={(e) => store.handleInputChange("skin_color", e.target.value)} className="mt-1" />
        ) : (
...
const RowEyeColor = observer(() => {
    ...
    return <div>
        ...
        {isEditing ? (
            <Input id="eye_color" value={displayCharacter?.eye_color} onChange={(e) => store.handleInputChange("eye_color", e.target.value)} className="mt-1" />
        ) : (
...
const RowYearOfBirth = observer(() => {
    ...
    return <div>
        ...
        {isEditing ? (
            <Input id="birth_year" value={displayCharacter?.birth_year} onChange={(e) => store.handleInputChange("birth_year", e.target.value)} className="mt-1" />
        ) : (
...
const RowGender = observer(() => {
    ...
    return <div>
        <Label>Пол</Label>
        {isEditing ? (
            <Select value={displayCharacter?.gender} onValueChange={(value) => store.handleInputChange("gender", value)}>
